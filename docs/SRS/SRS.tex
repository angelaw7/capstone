...
\begin{enumerate}[label=NFR\arabic*]
  ...
  \item (M) The application must load user data within five seconds.
  \item (M) The application must be responsive to user actions (e.g., adding an
  ...
  \item (M) The application should provide clear, informative error messages upon invalid
  inputs.
  \item (L) The application should guide users through corrective actions when
  ...
  \item (M) Information displayed to users must be concise and relevant, minimizing
...
\begin{enumerate}
  ...
  Our human-centred interfaces course (4HC3) will help us with designing interfaces that consider user experience and meet our <USABILITY> requirements. Also, all group members are currently taking (or have already taken) an introduction to machine learning course which will aid us in the development of the ML model. 
  ...
  The team has some introductory knowledge on machine learning models but we will need to research how to train existing models and how to train them efficiently and effectively as well.
