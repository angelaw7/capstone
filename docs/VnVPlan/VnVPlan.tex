...
\begin{itemize}
	\item Software Requirements Specification (SRS) document: This document
	outlines the functional and non-functional requirements of the Plutos
	application, which will be used as the basis for testing.
	\item Module Interface Specification (MIS) document: This document provides
	a detailed design of the Plutos application, which will be used to develop
	unit tests for each module.
	\item Module Guide: This document provides a detailed description of the
	software architecture and modules of Plutos, which will be used to develop
	unit tests for each module.
\end{itemize}
